...
DROP PROFILE web_application;
DROP PROFILE dba_admin;
DROP PROFILE analyst;
DROP PROFILE support_iii;
DROP PROFILE reporter;
DROP PROFILE auditor;
...
DROP USER developer_user; 
DROP USER web_user;
DROP USER dba_user;
DROP USER analyst_user; 
DROP USER support_user;
DROP USER reporter_user;
DROP USER auditor_user;
DROP USER backup_dba;
DROP USER backup_developer;
DROP USER backup_web;

-- Tables
DROP TABLE DEPOSIT_LIMITS;
DROP TABLE PROMO_CODES;
DROP TABLE PREFERENCES; 
DROP TABLE DOCUMENTS; 
DROP TABLE CITIES; 
DROP TABLE PROVIDENCES; 
